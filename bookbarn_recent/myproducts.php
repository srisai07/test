...
<!---END OF NAVBAR---->
                        ...
                        <form method="post" action="myproducts.php?action=id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="details col-md-6" >
                                ...
                                <div class="texts">
                                    <span>Contact:</span>
                                    <div>
                                        <span>Phone:</span> <?php echo $row["Phonenumber"]; ?><br/>
                                    <span>Email :</span> <?php echo $row["Email"]; ?></div>
                                </div>
                                ...
                                <a href="update.php?id=<?php echo $row["id"]; ?>&ti=<?php echo $row["Title"]; ?>&ca=<?php echo $row["Category"]; ?>&des=<?php echo $row["Description"]; ?>&pri=<?php echo $row["Price"]; ?>&ph=<?php echo $row["Phonenumber"]; ?>&ema=<?php echo $row["Email"]; ?>&loc=<?php echo $row["Location"]; ?>" name="update" id="button" class= "btn btn-success" role="button">Edit</a>
                                 
                                <a href="delete.php?action=delete&id=<?php echo $row["id"]; ?>&ema=<?php echo $row["Email"]; ?>" name="delete" id="button" class= "btn btn-danger" role="button">Delete</a>
                            </div>
                        </form>  
                </div>  
                <?php  
               ...
               <form method="post" action="home.html?email=<?php echo $email ?>">
